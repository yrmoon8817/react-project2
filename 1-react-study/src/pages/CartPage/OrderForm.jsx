...
class OrderForm extends React.Component{
  ...
  render(){
    return <form className="OrderForm" id="order-form" ref={this.formRef} onSubmit={this.handleSubmit}>
      ...
      <textarea name="messageToShop" id="messageToShop" row="5"></textarea>
      </FormControl>
      <FormControl label="라이더님께" htmlFor={'messageToRider'}>
      <textarea name="messageToRider" id="messageToRider" row="5"></textarea>
      </FormControl>
    </form>
  }
}
